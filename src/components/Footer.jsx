    ...
    <footer className="border-t border-border py-12 bg-background">
      <div className="container mx-auto flex flex-col items-center justify-between gap-6 px-6 md:flex-row">
        <div className="flex flex-col items-center gap-2 md:items-start">
          <span className="bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-secondary-accent)] bg-clip-text text-xl font-bold tracking-tighter text-transparent">
            Nurjaya.
          </span>
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Nurjaya. All rights reserved.</p>
        </div>
